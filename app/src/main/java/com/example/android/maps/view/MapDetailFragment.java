...
public class MapDetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Name = (TextView) view.findViewById(R.id.MapItemName);
        Address = (TextView) view.findViewById(R.id.MapItemAddress);
        Rating = (TextView) view.findViewById(R.id.MapItemRatings);
        Location = (TextView) view.findViewById(R.id.MapItemLocation);
        button =(Button) view.findViewById(R.id.MapItemButton);
        imageView = (ImageView) view.findViewById(R.id.MapItemImage);
